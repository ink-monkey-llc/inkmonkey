...
function ProductTypes() {
 return (
  <div className='rounded-b-lg border-2 bg-black border-bg-tertiary h-full justify-end items-end md:flex'>
   <div className='flex flex-col h-max bg-black'>
    {productTypes.map((type, i) => (
     <a
      ...
      href={type.url}>
      <div
       className={cn('cursor-pointer bg-black hover:bg-bg-secondary border-bg-tertiary px-4 py-2 transition-all')}
       key={type.id}>
