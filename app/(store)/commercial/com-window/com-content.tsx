...
function ComContent() {
 return (
  <div className='z-10 absolute flex-col items-center justify-center w-full h-full'>
   ...
   <Link
    href={'/commercial'}
    className=' group flex items-center justify-center px-8 py-4 bg-accent text-bg-primary font-semibold rounded-md w-max m-auto mt-2 md:mt-[15vh] cursor-pointer hover:bg-accent-bright hover:text-bg-primary transition-all md:px-12 md:py-6 md:text-xl'>
    Learn More
