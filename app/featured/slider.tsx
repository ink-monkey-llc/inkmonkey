  ...
  <div className='flex flex-col w-full bg-bg-secondary'>
   ...
   <div className='relative flex w-full'>
    <button
     ...
     <Chevron className='w-16 h-24 text-txt-primary bg-bg-secondary rounded-xl p-2 cursor-pointer opacity-70 hover:opacity-100 transition-all' />
    </button>
    <div
     ref={sliderRef}
    ...
    <button
     ...
     <Chevron
      className='w-16 h-24 text-txt-primary bg-bg-secondary rounded-xl p-2 cursor-pointer  opacity-70 hover:opacity-100 transition-all'
      direction={Direction.Right}
     />
    </button>
   </div>
