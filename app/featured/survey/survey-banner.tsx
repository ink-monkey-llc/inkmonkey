    ...
    <div className='flex flex-col '>
     <div className='flex'>
      ...
      <div
       ...
       className='sm:absolute top-2 right-2'>
       <Close className='w-6 h-6 text-accent cursor-pointer ml-auto hover:text-accent-bright' />
      </div>
     </div>
     <Link
      className='group border-2 max-w-[800px] m-2 sm:w-full sm:m-auto sm:mb-2 border-accent rounded-md mt-3 text-accent flex items-center justify-center py-2 text-xl sm:text-2xl hover:border-accent-bright hover:text-accent-bright transition-all'
      href='/survey'>
